  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col group/design-root overflow-x-hidden bg-background-light dark:bg-background-dark font-display text-primary dark:text-background-light">
      ...
      <div className="layout-container flex h-full grow flex-col">
        ...
        {/* Main Content */}
        <main className="flex flex-1 justify-center py-10 px-4 md:px-10 lg:px-20 xl:px-40">
          <div className="layout-content-container flex flex-col w-full max-w-4xl flex-1 gap-12 md:gap-16">
            
            {/* HeaderImage */}
            <div className="w-full">
              <div className="w-full bg-center bg-no-repeat bg-cover flex flex-col justify-end overflow-hidden h-64 md:h-80 lg:h-[420px] rounded-xl" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAluLtC2qFN7h8fuo501h7K9A83VDk8-uj-h5SRQ-repwcvNebQy6MXBYFEm0-yOi0Xy3XMjICUeDV8sB3Nu8lFjRk9xxFRPdH9Onc3KVxgcfv-mG82qSNziRq3zrVCBY5TDb1SjY_ZKBnjRy-C2chB5lwOrVR_1ROBVaOq_FmZhB-_AJr-HKIx3mgXoQRPOjNRMMwZSvrJTiGMhIV2NiwPR5i7u5SbQimoJyISvxaxw6zIWgVIJRzeFViC7jLqV_v-SoVwHILQUio")' }}></div>
            </div>

            {/* PageHeading */}
            <div className="flex flex-col gap-4 text-center px-4">
              <h1 className="text-primary dark:text-background-light text-4xl md:text-5xl lg:text-6xl font-light leading-tight tracking-tighter">Nuestra Historia</h1>
            </div>

            {/* BodyText */}
            <div className="px-4">
              <p className="text-primary dark:text-background-light text-base md:text-lg font-normal leading-relaxed text-center max-w-3xl mx-auto">
            ...
            {/* MetaText / Pull Quote */}
            <div className="px-4">
              <p className="text-neutral-500 dark:text-neutral-400 text-lg md:text-xl font-normal leading-normal py-8 px-4 text-center border-y border-primary/10 dark:border-background-light/10 italic">
                &quot;Creemos en la moda como una forma de expresión personal, no como una imposición.&quot;
              </p>
            </div>

            {/* Content Section: Our Philosophy */}
            <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center px-4">
              <div className="flex-1 flex flex-col gap-4">
                <h2 className="text-primary dark:text-background-light text-2xl md:text-3xl font-medium tracking-tight">Nuestra Filosofía</h2>
                <p className="text-primary dark:text-background-light text-base font-normal leading-relaxed">
