          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div id="contacto" className="text-center py-16 px-4">
              ...
              <div className="flex justify-center items-center gap-6">
                <a className="text-primary dark:text-background-light transition-transform hover:scale-110" href="https://wa.me/51998545204" target="_blank" rel="noopener noreferrer">
